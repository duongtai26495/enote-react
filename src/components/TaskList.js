...
const TaskList = ({ note, updateProgressState }) => {
    ...
    const PleaceholderTask = () => {
        return (
            <ul className='w-full flex flex-row gap-1 justify-start bg-slate-300 py-2'>
                <li onClick={() => addNewTask(CHECK_TYPE)} className='button_style-1 flex flex-row w-fit gap-2 text-xs font-bold items-center p-1 text-slate-600 rounded-md mx-2 cursor-pointer lg:hover:bg-slate-500 lg:hover:text-white hover:fill-white bg-white transition-all justify-center'>
                ...
                <li onClick={() => addNewTask(NOTE_TYPE)} className='button_style-1 flex flex-row w-fit gap-2 text-xs font-bold items-center p-1 text-slate-600 rounded-md mx-2 cursor-pointer lg:hover:bg-slate-500 lg:hover:text-white hover:fill-white bg-white transition-all justify-center'>
