...
const WorkspaceItem = ({ wsItem, removeWs, setAddNoteState }) => {
    ...
    return (
        ...
        <div className={`flex flex-row md:flex-col items-center gap-2 m-auto w-fit`}>
            ...
            <div className={`w-fit transition-all ease-out duration-700 overflow-hidden flex-row items-center justify-around ws-action relative ${selectedWs === currentWssItem.id ? "flex" : "hidden"}`}>
