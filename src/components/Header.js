                ...
                <nav className="flex flex-col lg:flex-row justify-between gap-5 lg:gap-0 relative">
                    ...
                    <div className="flex space-x-5 justify-between lg:justify-center items-center pl-2">
                        ...
                        <div className={`w-1/3 lg:w-fit lg:border-l-2  border-l-neutral-500 relative cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 `}>
                            ...
                            <div className={`w-fit border gap-2 flex flex-col px-4 py-2 absolute z-20 right-0 top-10 ${isLogoutBadge ? "h-fit opacity-100" : "h-0 opacity-0"} overflow-hidden transition-all bg-white rounded-lg`}>
