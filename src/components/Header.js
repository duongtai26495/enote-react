                ...
                <nav className="flex flex-col lg:flex-row justify-between gap-5 lg:gap-0">
                    <div className="lg:pr-16 pr-0">
                        <Link className="flex items-center justify-center space-x-2 flex-row " to={"/"}>
                            ...
                            <h2 className="font-normal text-lg lg:text-2xl leading-6 text-gray-800" style={{ color: "#b70000" }}>eMemo</h2>
                        </Link>
                    </div>
                    ...
                    <div className="flex space-x-5 justify-between lg:justify-center items-center pl-2">
                        <div className="w-full lg:w-fit gap-3 flex flex-row-reverse justify-end lg:flex-row">
                        ...
                        <div className={`w-full lg:w-fit lg:border-l-2 lg:pl-2 border-l-neutral-500 relative cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 `}>
                            {
                                userInfo &&
                                <p onClick={toggleLogoutBadge} className="text-center w-full justify-end px-2 flex flex-row gap-2 items-center text-slate-700">Hi, <strong>{userInfo.f_name} {userInfo.l_name}</strong>
                            ...
                            <div className={`w-fit absolute z-10 right-0 top-10 ${isLogoutBadge ? "h-fit opacity-100" : "h-0 opacity-0"} overflow-hidden transition-all bg-white rounded-lg`}>
                                ...
                                <p className={`flex cursor-pointer flex-row gap-2 whitespace-nowrap items-center bg-white border shadow transition-all p-2 `} onClick={() => logout()} >
                                    <span>Log out</span>
