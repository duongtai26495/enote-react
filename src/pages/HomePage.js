  ...
  const RenderSort = () => {
    ...
    return (
      <div className='w-fit flex gap-1 items-center font-bold '>
        ...
        <select className='w-full lg:w-fit bg-white border p-2 font-bold cursor-pointer rounded-md text-sm lg:hover:shadow-lg transition-all' name='sort_note' id='sort_note'
          ...
          <div className='flex items-center gap-2'>
            ...
            <div className={"flex flex-row gap-5 w-14 min-w-fit"}>
              <button onClick={() => addWorkspace()}
                ...
                className='py-2 px-3 w-full border cursor-pointer transition-all rounded-md whitespace-nowrap text-black bg-white lg:hover:shadow-lg font-bold text-sm'>
