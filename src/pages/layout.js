...
function Layout() {
  ...
  return (
    <div className='w-full m-auto relative'>
      ...
      <Header />
      <main className='w-full m-auto px-2 h-full flex flex-col lg:flex-row min-h-screen'>
        <div className={`${isExpandSidebar ? "w-full lg:w-3/4" : "w-full"} duration-500 delay-200 ease-out transition-all relative flex flex-row`}>
          ...
          <div className='w-1 h-full hidden lg:flex flex-col border-r border-red-700 relative justify-center' onClick={() => handleExpandSidebar()}>
