...
const Login = () => {
    ...
    return (
        <>
            ...
            <section className={`${isLoading ? "hidden" : "flex"} flex-col md:flex-row h-screen items-center`}>
                    ...
                    <div className="w-full h-100">
                        ...
                        <form className="mt-6" onSubmit={handleSubmit}>
                            <div className="flex items-center border-2 py-2 px-3 rounded-lg mb-4">
                                ...
                                <input className="w-full pl-2 outline-none border-none" type="text" name="username_login" id="username_login" placeholder="Username" />
                            </div>
                            <div className="flex items-center border-2 py-2 px-3 rounded-lg">
                                ...
                                <input className="w-full pl-2 outline-none border-none" type="password" name="pw_login" id="password_login" placeholder="Password" />
                            </div>

                            <div className="text-right mt-2">
                                <Link to={"/recovery"} className="text-sm font-semibold text-gray-700 lg:hover:text-blue-700 focus:text-blue-700">Forgot Password?</Link>
                            </div>

                            <button type="submit" className="w-full block bg-indigo-500 lg:hover:bg-indigo-400 focus:bg-indigo-400 text-white font-semibold rounded-lg
                px-4 py-2 mt-6">Log In</button>
                        </form>

                        <hr className="my-6 border-gray-300 w-full" />

                        <button type="submit" className="w-full block bg-white lg:hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-2 border border-gray-300">
                        ...
                        <p className="mt-8">Need an account? <Link to="/register" className="text-blue-500 lg:hover:text-blue-700 font-semibold">Create an
                            account</Link></p>
